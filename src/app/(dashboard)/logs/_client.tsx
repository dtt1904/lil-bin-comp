...
function getLogLevelDotColor(level: string) {
...
export function LogsPageClient({ logEvents, workspaces, agents }: LogsPageClientProps) {
  ...
  }, [logEvents, search, levelFilter, workspaceFilter, agentFilter]);
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "text-xs truncate",
                        event.agent ? "text-foreground" : "text-muted-foreground"
                      )}
                    >
                      {event.agent?.name ?? "—"}
                    </span>
